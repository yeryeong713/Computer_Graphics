...
const pointLight1 = new THREE.PointLight(0xff0000, 0.3, 15, 3);
const pointLightHelper1 = new THREE.PointLightHelper(pointLight1, 1);

const ambientLight2 = new THREE.AmbientLight(0xffffff, 0.3);
const pointLight2 = new THREE.PointLight(0x00ff00, 0.3, 15, 3);
const pointLightHelper2 = new THREE.PointLightHelper(pointLight2, 1);

const ambientLight3 = new THREE.AmbientLight(0xffffff, 0.3);
const pointLight3 = new THREE.PointLight(0x0000ff, 0.3, 15, 3);
...
function initGUI() {
    ...
    const pointFolder1 = gui.addFolder('PointLight1')
    pointFolder1.add(pointLight1.position, 'x', -10, 10);
    pointFolder1.add(pointLight1.position, 'y', -10, 10);
    pointFolder1.add(pointLight1.position, 'z', -10, 10);

    const pointFolder2 = gui.addFolder('PointLight2')
    pointFolder2.add(pointLight2.position, 'x', -10, 10);
    pointFolder2.add(pointLight2.position, 'y', -10, 10);
    pointFolder2.add(pointLight2.position, 'z', -10, 10);

    const pointFolder3 = gui.addFolder('PointLight3')
    pointFolder3.add(pointLight3.position, 'x', -10, 10);
    pointFolder3.add(pointLight3.position, 'y', -10, 10);
    pointFolder3.add(pointLight3.position, 'z', -10, 10);
    pointFolder3.add(pointLight3, 'distance', 0, 100);
    pointFolder3.add(pointLight3, 'decay', 0, 10);
